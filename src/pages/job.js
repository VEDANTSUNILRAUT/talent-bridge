...
function Job() {
  ...
  const currentCompanies = [
    ...
    {
      name: "SecureNet Inc",
      status: "Looking for Specialists",
      industry: "Cybersecurity",
    },
    {
      name: "AI Pioneers",
      status: "Hiring Researchers",
      industry: "Artificial Intelligence",
    },
    {
      name: "Green Solutions",
      status: "Expanding Teams",
      industry: "Environment",
    },
  ];
  ...
  return (
    <div className="job-page">
      ...
      <div className="job-header">
        ...
        />
        <button className="hamburger-button" title="Menu">
          &#9776;
        </button>
      </div>
          ...
          {upcomingCompanies.map((company, index) => (
            <div key={index} className="company-card upcoming ">
              ...
              <div className="job-actions">
                <button className="viewdetail-btn">View Details</button>
              </div>
            </div>
          ))}
        </div>
